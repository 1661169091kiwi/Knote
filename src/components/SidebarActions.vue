<script setup>
defineProps({ t: Function, lang: String, viewMode: String, stats: Object, saving: Boolean, pdf: Boolean, prefix: { type: String, default: 'sidebar' } })
defineEmits(['open', 'save', 'view', 'language', 'theme', 'more'])
</script>
<template>
